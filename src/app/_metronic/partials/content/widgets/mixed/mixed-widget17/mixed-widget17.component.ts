...
@Component({
  selector: 'app-mixed-widget17',
  templateUrl: './mixed-widget17.component.html',
  providers: [
...
export class MixedWidget17Component implements OnInit {
  fuelDealerId: any;
  ...
  ngOnInit(): void {
    ...
    this.oldInvoice = this.post.oldInvoice2
