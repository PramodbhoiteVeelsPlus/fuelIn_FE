...
export class BaseTablesService {
    ...
    // getDayWiseLedgerQtyNewURL
    getDayWiseLedgerQtyNewPOST(body: Object): Observable<any> {
        this.setHeader();
        let headers = new HttpHeaders();
        headers = headers.set('authenticationToken', this.token);
        return this.http.post(this.getDayWiseLedgerQtyNewURL, body, {
            headers: headers
        })
    }

    // getMonthlyCrDetailsQtyNewURL
    getMonthlyCrDetailsQtyNewPOST(body: Object): Observable<any> {
        this.setHeader();
        let headers = new HttpHeaders();
        headers = headers.set('authenticationToken', this.token);
